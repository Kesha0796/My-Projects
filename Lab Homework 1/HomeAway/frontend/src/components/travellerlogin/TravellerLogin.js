                    ...
                    <div class="main-div">
                        <div class="panel">
                            ...
                            <div class="form-group">
                                <input class="form-control" onChange = {this.usernameChangeHandler} type="text" name="username" placeholder="Email Address" autofocus/>
                            </div>
                            <div class="form-group">
                                <input class="form-control" onChange = {this.passwordChangeHandler} type="password" name="password" placeholder="Password"/>
                            </div>
                            <div class="forgot a">
