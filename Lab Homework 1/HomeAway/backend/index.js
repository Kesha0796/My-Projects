...
app.post('/locdata',function(req,res){
    ...
    // }else{
        console.log(req.body);
        var newprop = {propid:1,add1: req.body.add1, add2: req.body.add2, city : req.body.city,zipcode: req.body.zipcode, country: req.body.country, headline:"",description:"",proptype:"",bedrooms:"",accomodates:"",bathrooms:"",startdate:"",enddate:"",currency:"",Nightbaserate:"",minstay:"",userid:req.body.cookiedata};
