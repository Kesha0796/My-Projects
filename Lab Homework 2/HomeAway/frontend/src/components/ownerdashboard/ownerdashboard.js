...
class ownerdashboard extends Component
{
    ...
    componentDidMount(){
        ...
        this.setState({
            properties : this.state.properties.concat(response.data.updatedList.result) ,
    ...
    myDelete(propertyid)
        {
                ...
                this.props.onPropClickHandle(data);
    ...
    render()
    {
            ...
            return (
                <div class="row border1" onClick={() => this.myDelete(property._id)}>
                    <div class="col-sm-6">                   
                            ...
                            <img class="imgformat" src={currentimages[i]} onClick={() => this.myDelete(property.propertyid)}></img> 
        ...
        var names=cookie.load("ownername");
        return(      
