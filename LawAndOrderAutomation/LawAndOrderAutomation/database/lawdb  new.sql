...
--
-- Host: localhost
-- Generation Time: Mar 20, 2018 at 06:55 AM
...
-- Database: `lawdb`
--
CREATE DATABASE IF NOT EXISTS `lawdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `lawdb`;
...
(1, '2018-03-02', 'jugal', 'fawfwfwafwq.pdf', '0', 1, 'shfaehf');
...
CREATE TABLE IF NOT EXISTS `detective_login_signup` (
  ...
  `PoliceStatus` int(11) NOT NULL DEFAULT '0',
  `AdminStatus` int(11) NOT NULL DEFAULT '0',
  `DetectiveName` varchar(25) DEFAULT NULL,
...
INSERT INTO `detective_login_signup` (`Detective_id`, `Detective_Proof`, `Phone_Number`, `Email_id`, `Password`, `NameOfTheOrganisation`, `PoliceStatus`, `AdminStatus`, `DetectiveName`) VALUES
(1, 'assfasvhasjk', 9898822, 'kesha@gmail.com', 'kesha', 'kesha', 1, 1, 'kesha'),
(2, 'asfasa', 980998987, 'mehar@gmail.com', 'mehar', 'mehar', 0, 1, 'mehar');
...
(747326527, 'arms', 'khfsnkh', '0', 'khgkrhsk', 'kdjg,snk', 856856, '2017-09-06', 'jgkdi', '-1');
