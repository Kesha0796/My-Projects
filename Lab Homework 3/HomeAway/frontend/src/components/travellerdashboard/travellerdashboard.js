...
class travellerdashboard extends Component
{
    ...
    componentDidMount()
    {
        ...
        var data=this.props.client.query(
            ...
            console.log("Data",res.data.Search);
                ...
                this.setState({
                    properties : this.state.properties.concat(res.data.Search) 
                });
    ...
    myDelete(propertyid,username,address,city,country,zipcode,headline)
    {
    ...
    render()
    {
        ...
        i=i+1
                return (
                    ...
                    <div class="col-sm-6">                   
                    <img class="imgformat" src={currentImages[i]} onClick={this.myDelete.bind(this,property._id,property.username,property.address,property.city,property.country,property.zipcode,property.headline)}></img> 
                    </div>
...
export default compose(graphql(Search,{name:"Search"}),connect(mapStateToProps,mapDispatchStateToProps))(withApollo(travellerdashboard));