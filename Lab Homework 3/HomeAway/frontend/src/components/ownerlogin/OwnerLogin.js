...
class OwnerLogin extends Component
{
    ...
    submitLogin = (e) => {
        ...
        var data=this.props.client.query(
            ...
            if(res.data.Login)
            {
                localStorage.setItem("owneremail",res.data.Login.username);
...
export default compose(graphql(Login,{name:"Login"}),connect(mapStateToProps,mapDispatchStateToProps))(withApollo(OwnerLogin));
