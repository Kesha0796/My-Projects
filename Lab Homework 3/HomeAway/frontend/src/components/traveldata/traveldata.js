...
import { Propertydetail } from '../../queries/queries';
import { BookMutation } from '../../mutation/mutations';
...
class traveldata extends Component
{
    ...
    componentDidMount(){
        ...
        var data=this.props.client.query(
            ...
            console.log("Data",res.data.Propertydetail);
            
            
                this.setState({
                    properties : this.state.properties.concat(res.data.Propertydetail) 
                });
    ...
    myDelete(headline,rate)
        {
                ...
                var data1={
                    ...
                    guests:localStorage.getItem("accomodates"),
                    city:localStorage.getItem("city"),
                    rates:rate
                }
                
                var data=this.props.BookMutation(
                    {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        <path d="M6.9,8.9l-0.5,5.9c0,0.6,0.2,0.7,0.5,0.2l5.6-7c0.3-0.4,0.2-0.8-0.4-0.8h-3l0.5-5.9 c0-0.6-0.2-0.7-0.5-0.2l-5.6,7C3.1,8.5,3.3,8.9,3.9,8.9H6.9z"></path>
                ...
                <div class="row ">
                    <div class="col-sm -6 divformatbook"><input type = "submit" value= "Book" class="btn btn-primary" onClick={() => this.myDelete(property.headline,property.Nightbaserates)} /></div>
...
export default compose(graphql(Propertydetail,{name:"Propertydetail"}),graphql(BookMutation, { name: "BookMutation" }),connect(mapStateToProps,mapDispatchStateToProps))(withApollo(traveldata));
