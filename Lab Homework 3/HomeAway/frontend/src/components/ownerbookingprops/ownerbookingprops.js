        ...
        var data=this.props.client.query(
            {
                ...
                variables:{
                    headline:localStorage.getItem("ownerheadline"),
                }
            }
        ).then(res=>{
...
export default compose(graphql(Propertydetail,{name:"Propertydetail"}),connect(mapStateToProps,mapDispatchStateToProps))(withApollo(traveldata));
